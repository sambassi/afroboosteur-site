    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 mt-1">
            Gérez et générez vos documents administratifs
          </p>
        </div>
      ...
      <div className="bg-[#2a1a2a]/50 backdrop-blur-sm border border-[#8a2be2]/20 rounded-2xl p-12 text-center">
        ...
        <p className="text-gray-400 text-sm max-w-md mx-auto mb-6">
          Générez des documents PDF, DOCX et Excel à partir de templates personnalisés avec insertion automatique des données de vos projets.
        </p>
